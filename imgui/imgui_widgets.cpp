...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    RenderFrame(frame_bb.Min, frame_bb.Max, ImColor(190 / 255.0f, 66 / 255.0f, 66 / 255.0f, it_anim->second.animation), false, 9.0f);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    const ImRect rect(window->DC.CursorPos, window->DC.CursorPos + ImVec2(size, 45));
    const ImRect clickable(window->DC.CursorPos + ImVec2(0, 23), window->DC.CursorPos + ImVec2(size, 45));
    ...
    RenderTextClipped(clickable.Min + ImVec2(14, 3), clickable.Max - ImVec2(24, -35), preview_value, NULL, NULL, ImVec2(0.0f, 0.0f));

    PushFont(combo_arrow); {
        window->DrawList->AddText(ImVec2(clickable.Max.x - 20, (clickable.Min.y + clickable.Max.y) / 2 - arrow_size.y / 2), ImColor(190 / 255.0f, 66 / 255.0f, 66 / 255.0f, 0.7f + it_anim->second.arrow_anim), "A");
    } PopFont();
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    window->DrawList->AddRectFilled(frame_bb.Min, ImVec2(grab_bb.Min.x + 3, frame_bb.Max.y), ImColor(190, 66, 66), 5.0f);
