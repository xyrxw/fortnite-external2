...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Vertical Sliders"))
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            ...
            ImGui::PushID(i);
            ImGui::PushStyleColor(ImGuiCol_FrameBg, (ImVec4)ImColor::HSV(i / 0.26f, 0.05f, 0.38f));
            ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, (ImVec4)ImColor::HSV(i / 0.18f, 0.19f, 0.57f));
            ImGui::PushStyleColor(ImGuiCol_FrameBgActive, (ImVec4)ImColor::HSV(i / 0.52f, 0.37f, 0.65f));
            ImGui::PushStyleColor(ImGuiCol_SliderGrab, (ImVec4)ImColor::HSV(i / 0.96f, 0.59f, 0.61f));
    ...
    if (ImGui::TreeNode("Querying Item Status (Edited/Active/Hovered etc.)"))
    {
        ...
        if (item_type == 4) { ret = ImGui::SliderFloat("ITEM: SliderFloat", &col4f[0], 0.63f, 0.4f); }   // Testing basic item
